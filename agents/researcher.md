...
4. For the 2-3 most promising source URLs, use `fetch_content` to get full page content. When `fetch_content` returns multi-URL summaries, use `get_search_content` to retrieve full page slices from the stored result.
